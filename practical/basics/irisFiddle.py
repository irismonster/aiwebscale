...
for i in range(number_experiments):
    ...
    regret_accumulator[:,1] += run_bandit_alg(true_rewards,CTRs_that_generated_data,thompson_sampling)
...
plt.legend(('Random','TS','Epsilon-Greedy','(1 - 1/t) UCB','95% UCB'),loc='lower right')
plt.show()